...
initial_state_values_2 <- c(S = 999999 - 100000,  # Número de susceptibles inicial
                                       # 
                          I = 100000,    # Se inicia con una persona infectada
                          R = 0)
############
output_Beta_1 <- as.data.frame(ode(y = initial_state_values_2, 
                            times = times_1_yr, 
                            func = sir_model,
